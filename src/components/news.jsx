...
function News() {
  return (
    <div class="news w-full px-0 pt-[143px] pb-[150px] text-left" id="new">
            ...
            >
              <div class="list_inner w-full h-full clear-both relative">
                <div class="image relative mb-[10px] overflow-hidden">
                  ...
                  ></div>
                  <span class="date absolute z-[1] top-[20px] left-[20px] bg-white inline-block py-[5px] px-[20px]">
                    Nov 30, 2024
                  </span>
                ...
                <div class="details w-full bg-[#f5f5f5]">
                  ...
                  <div class="title w-full p-[30px]">
                    <h3 class="text-[20px]">
                      <a class="text-black text_hover_effect" href="#">
                ...
                <div class="news_hidden_details">
                  <div class="news_popup_informations">
                    <div class="text">
                      <p>
                        Erling is a leading web design agency with an
                      ...
                      <p>
                        ...
                        their website’s design but also partnering with Erling,
